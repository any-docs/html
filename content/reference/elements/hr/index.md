...
- `align` {{deprecated_inline}} <Badge type="info" text="Non-standard. Check cross-browser support before using." />
  - Sets the alignment of the rule on the page. If no value is specified, the default value is `left`.
- `color` {{deprecated_inline}} <Badge type="info" text="Non-standard. Check cross-browser support before using." />
  - Sets the color of the rule through color name or hexadecimal value.
- `noshade` {{deprecated_inline}} <Badge type="info" text="Non-standard. Check cross-browser support before using." />
  - Sets the rule to have no shading.
- `size` {{deprecated_inline}} <Badge type="info" text="Non-standard. Check cross-browser support before using." />
  - Sets the height, in pixels, of the rule.
- `width` {{deprecated_inline}} <Badge type="info" text="Non-standard. Check cross-browser support before using." />
