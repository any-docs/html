...
- `allowpaymentrequest` {{deprecated_inline}} <Badge type="info" text="Non-standard. Check cross-browser support before using." />
...
- `browsingtopics` <Badge type="info" text="Non-standard. Check cross-browser support before using." /> {{deprecated_inline}}
