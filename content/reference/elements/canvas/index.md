...
- `moz-opaque` <Badge type="info" text="Non-standard. Check cross-browser support before using." /> {{deprecated_inline}}
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/en-US/docs/Web/HTML/Reference/Elements/input#type"><code>type</code></a> attribute is
