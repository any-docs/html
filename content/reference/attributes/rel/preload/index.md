...
One nice feature of `<link>` elements is their ability to accept [`media`](/en-US/docs/Web/HTML/Reference/Elements/link#media) attributes. These can accept [media types](/en-US/docs/Web/CSS/Reference/At-rules/@media#media_types) or full-blown [media queries](/css/guides/Media_queries/Using), allowing you to do responsive preloading!
