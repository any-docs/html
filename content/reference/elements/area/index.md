...
- `coords`
  - The `coords` attribute details the coordinates of the [`shape`](#shape) attribute in size, shape, and placement of an `<area>`.
    ...
    The values are numbers of CSS pixels. Our [shape generator](/css/guides/Shapes/Shape_generator) can help you generate the `coords` syntax by selecting points on an image you upload.
