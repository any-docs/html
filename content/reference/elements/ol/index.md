...
- `compact` {{Deprecated_inline}} <Badge type="info" text="Non-standard. Check cross-browser support before using." />
...
- CSS properties that may be specially useful to style the `<ol>` element:
  ...
  - [CSS counters](/css/guides/Counter_styles/Using_counters), to handle complex nested lists
