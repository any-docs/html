...
There is no custom [CSS](/en-US/docs/Web/CSS) or [user stylesheet](/css/guides/Cascade/Introduction#author_stylesheets) applied to this table. The styling results purely from the [user-agent stylesheet](/css/guides/Cascade/Introduction#user-agent_stylesheets).
